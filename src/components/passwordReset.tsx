...
export default function PasswordReset(email: any) {
  ...
  const submitForm = async (data: any) => {
    ...
    try {
      const req = await fetch(
        `${process.env.NEXT_PUBLIC_backend_Link}resetPassword`,
        {
          method: "POST",
          body: formData,
  ...
  return (
    <main
      ...
      id="passwordResetMain"
    >
      <form
        className="bg-white shadow-md shadow-white w-[40%] h-[60%]  flex-col justify-around text-xl"
