    ...
    <footer className="bg-[#0f0f0f] border-t border-[#1e1e1e] text-[#a3a3a3] flex flex-wrap items-center justify-around p-12 gap-16">
      ...
      <div className="flex flex-col gap-6 min-w-[220px]">
        ...
        <div className="flex flex-col gap-1">
          <p className="text-white font-medium text-sm">Tampa Palms</p>
          <p className="text-[#a3a3a3] text-sm">15309A Amberly Dr. 33647</p>
          <a
            className="text-[#ff4d00] hover:text-[#ff6b2b] transition-colors text-sm"
        ...
        <div className="flex flex-col gap-1">
          <p className="text-white font-medium text-sm">South Tampa</p>
          <p className="text-[#a3a3a3] text-sm">4045 S Dale Mabry Hwy 33611</p>
          <a
            className="text-[#ff4d00] hover:text-[#ff6b2b] transition-colors text-sm"
      ...
      <div className="flex flex-col gap-6 ">
        ...
        <div className="flex flex-col gap-3">
          <a className="text-[#a3a3a3] hover:text-[#ff4d00] transition-colors text-sm" href="#">
            Terms of Service
          </a>
          <a className="text-[#a3a3a3] hover:text-[#ff4d00] transition-colors text-sm" href="/refunds">
            Refund Policy
          </a>
        </div>
        <p className="text-[#525252] text-xs mt-auto">©2024 Xtreme Body Nutrition</p>
      </div>

      {/* Social */}
      <div className="flex flex-col gap-4 items-start justify-start">
        <p className="text-xs uppercase tracking-widest text-[#525252] font-semibold">Follow Us</p>
        <div className="flex gap-4">
          <a
            href="https://www.linkedin.com/company/xtremebody-nutrition-llc/"
          ...
          <a
            href="https://www.facebook.com/xbnutrition/"
            className="opacity-50 hover:opacity-100 transition-opacity"
          >
            <svg width="22" height="22" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <a
            href="https://www.instagram.com/xtremebodynutrition/?hl=en"
            className="opacity-50 hover:opacity-100 transition-opacity"
          >
            <svg width="22" height="22" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
