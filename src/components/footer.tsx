        ...
        <footer className="bg-[#353935] text-white flex text-xl p-16">
          <div className=" flex-col flex justify-around items-center   w-[40%]">
           ...
           <div className="flex-col">
              <p className='font-semibold'>South Tampa - 4045 S Dale Mabry Hwy 33611</p>
              <a className='ml-10 underline hover:text-orange-500' href="tel:813-542-4150">(813) 542-4150</a>
           </div>
          </div>
